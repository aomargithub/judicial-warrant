...
public class SecurityServiceImpl implements SecurityService{
	...
	@Override
	public UserDetailsDto getUserDetails(HttpSession session) throws JudicialWarrantInternalException {
	...
	private UserDetailsDto toUserDetailsDto(JudicialWarrantUserDetails userDetails) {
		...
		userDetailsDto.setOrganizationUnit(organizationUnitMapper.toDto(userDetails.getOrganizationUnit()));
