...
public class AttachmentTypeHandlerImpl implements AttachmentTypeHandler {
	...
	@Override
	public ResponseEntity<AttachmentTypeDto> getById(Byte id, Short etag) throws JudicialWarrantException {
	...
	@Override
	public ResponseEntity<AttachmentTypeDto> update(AttachmentTypeDto attachmentTypeDto, Byte id,
