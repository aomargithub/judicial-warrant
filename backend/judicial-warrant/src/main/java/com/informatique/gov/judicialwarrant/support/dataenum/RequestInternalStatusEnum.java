...
public enum RequestInternalStatusEnum {
	...
	CAPACITY_DELEGATION_LAW_AFFAIRS_REVIEW("JWCD_LAW_AFFAIRS_REVIEW", RequestStatusEnum.INPROGRESS),
	CAPACITY_DELEGATION_LAW_AFFAIRS_REJECTED("JWCD_LAW_AFFAIRS_REJECTED", RequestStatusEnum.INPROGRESS),
	CAPACITY_DELEGATION_LAW_AFFAIRS_ACCEPTED("JWCD_LAW_AFFAIRS_ACCEPTED", RequestStatusEnum.INPROGRESS),
