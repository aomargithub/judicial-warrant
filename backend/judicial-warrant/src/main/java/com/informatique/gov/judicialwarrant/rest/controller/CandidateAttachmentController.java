...
public class CandidateAttachmentController implements Serializable {
	...
	*/
	...
	@PostMapping
	public ResponseEntity<?> save(@RequestBody CandidateAttachmentDto candidateAttachmentDto) throws JudicialWarrantException {
		return candidateAttachmentHandler.save(candidateAttachmentDto);
	}
